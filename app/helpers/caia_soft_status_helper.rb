module CaiaSoftStatusHelper
  ...
  EQUIVALENCIES = {
    ...
    NOT_FOUND => [
      ...
      IN_FREEZER, IN_STORAGE_AWAITING_INGEST, WorkflowStatus::IN_STORAGE_INGESTED_OFFSITE,
      MISSING, SHIPPED_EXTERNALLY, WorkflowStatus::DEACCESSIONED, IN_WORKFLOW_ALF,
      IN_WORKFLOW_WELLS
    ],
